...
export const useSendMessageHistoryMutation = (chatId?: string) => {
...
export const useEditMessageHistoryMutation = (chatId?: string) => {
  const queryClient = useQueryClient();
...
export const useRegenerateMessageHistoryMutation = (chatId?: string) => {
  const queryClient = useQueryClient();
